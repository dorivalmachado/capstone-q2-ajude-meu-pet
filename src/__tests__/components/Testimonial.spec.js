...
describe("Testimonial Component when OK", () => {
  it("should be able to render a component containing specif content", () => {
    ...
    const textContent1 = "Eu era gordinha e cansadinha, sempre comendo demais e não fazendo nenhum exercício, mas com Ajude meu pet, fiquei malhada e gostosa!";
    const textContent2 = 'Meu dono não me levava para passear, mas com Ajude meu Pet, estou caminhando 10km por dia, e treinando para a São Silvestre.';
    const textContent3 = 'Eu era um vida loka, não estava nem aí para as leis e muros, fugia de casa voltava a hora que queria, estava despediçando meu tempo, mas com o Ajude meu pet, dei a volta por cima, e esse ano, me formo em direito.';
    ...
    expect(imgElement3).toHaveAttribute('src', 'Depo3.jpg');
